...
namespace Zork
{
    class Program
    {
        ...
        private static void InitializeRoomDescriptions()
        {
            ...
            Rooms[0, 1].Description = "You are facing the south side of a white house. There s no door here and all the windows are barred.";
            Rooms[0, 2].Description = "You are at the top of the Great Conyon on its south wall.";
